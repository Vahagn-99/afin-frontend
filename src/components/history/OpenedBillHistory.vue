<template>
  ...
  <HistoryOpenedBillFilter v-if="isOpenFilter" @close-filter="closeFilter" @filter="filter" @clear="clear"/>
</template>
<script setup>
...
import {useHistoryOpenedBillStore} from "@/stores/history_opened_bill.js";
import {useRoute} from "vue-router";
import HistoryOpenedBillFilter from "@/modals/filter/HistoryOpenedBillFilter.vue";
import {names} from "@/helper/const.js";


const isLoading = ref(false)
const isOpenFilter = ref(false)
const openedBillStore = useHistoryOpenedBillStore()
...
function changeCount(p) {
  ...
  setTimeout(async () => {
    await openedBillStore.getOpenedBills(id.value)
